...
def main():
    ...
    # data_dir = 'D:\Desktop\data'
    # tra_image_dir = '\DUST\DUTS-TR\DUTS-TR-Image\\'
    # tra_label_dir = '\DUST\DUTS-TR\DUTS-TR-Mask\\'

    data_dir = r'E:\datasets\VOC-2007\VOCtrainval_06-Nov-2007\VOCdevkit\VOC2007'
    tra_image_dir = r'\JPEGImages\\'
    tra_label_dir = r'\SegmentationClass\\'
    ...
    tra_lbl_name_list = glob.glob(data_dir + tra_label_dir + '*')
    ...
    for epoch in range(0, epoch_num):
        ...
        for i, data in enumerate(salobj_dataloader):
            ...
            # loss2 《== d0 , loss 《== d0、d1、d2、d3、d4、d5、d6
